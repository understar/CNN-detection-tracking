...
for /l %%i in (83,1,111) do filter_polys.py ./segmentation/MS04/results5/MOS%%i.shp 0.95
...
for /l %%i in (83,1,111) do poly2ras.py ./segmentation/MS04/results5/95out_MOS%%i.shp ./segmentation/MS04/results5/MOS%%i.shp

:将分割结果导出位置，面积及方向等
REM for /l %%i in (62,1,68) do ras2loc.py ./segmentation/MA01/ON00%%i.tif ./segmentation/MA01/results5/95out_ON00%%i.tif

for /l %%i in (83,1,111) do ras2loc.py ./segmentation/MS04/MOS%%i.tif ./segmentation/MS04/results5/95out_MOS%%i.tif
