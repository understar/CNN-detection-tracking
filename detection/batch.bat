...
for /l %%i in (83,1,85) do filter_polys.py ./segmentation/MS04/results5/MOS%%i.shp 0.95
...
for /l %%i in (83,1,85) do poly2ras.py ./segmentation/MS04/results5/95out_MOS%%i.shp ./segmentation/MS04/results5/MOS%%i.shp
